...
@Slf4j
public class DayProcessor11 implements PaintProcessor {

    private int rel = 0;
    private int counter = 0;
    @Getter
    Long outputColour = null;
    @Getter
    Long outputDirection = null;
    int current = 0;
    List<Long> numbers = new ArrayList<>();

    public DayProcessor11(List<String> lines) {
...
//                    log.info("Mul {} + {} = {} to {}", val1b, val2b, sumb, numbers.get(current + 3));
                ...
                case 4:
                    ...
                    if (outputColour == null) {
                        outputColour = getValue(numbers, param1, (current + 1));
                    } else {
                        outputDirection = getValue(numbers, param1, (current + 1));
                    }
...
//                    if (numbers.get(val4) != 0) return;
                    ...
                    if (outputDirection != null) {
                        log.info("------------------- OUTPUT {} {} ------------------", outputColour, outputDirection);
                        return true;
                    }
